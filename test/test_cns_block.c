...
START_TEST(test_block_expand)
{
	...
	ck_assert_int_eq(block->ibuf->head, 7);
	ck_assert_int_eq(block->wbuf->dtype, CNS_INT8);
	ck_assert_int_eq(block->wbuf->length, 10);
	ck_assert_int_eq(block->wbuf->head, 7);
	ck_assert_int_eq(block->obuf->dtype, CNS_INT8);
	ck_assert_int_eq(block->obuf->length, 10);
	ck_assert_int_eq(block->obuf->head, 6);
	ck_assert_int_eq(block->cbuf->dtype, CNS_INT8);
	ck_assert_int_eq(block->cbuf->length, 10);
	ck_assert_int_eq(block->cbuf->head, 9);
	ck_assert_int_eq(((cns_buf_ii *)block->ibuf->iis[0]->data)->idx, 0);
	ck_assert_int_eq(((cns_buf_ii *)block->ibuf->iis[0]->data)->itft, CNS_INPUT);
	ck_assert_ptr_eq(block->ibuf->iis[0]->next, NULL);
	ck_assert_int_eq(((cns_buf_ii *)block->ibuf->iis[1]->data)->idx, 1);
	...
	ck_assert_int_eq(((cns_buf_ii *)block->ibuf->iis[5]->data)->idx, 5);
	ck_assert_int_eq(((cns_buf_ii *)block->ibuf->iis[5]->data)->itft, CNS_INPUT);
	ck_assert_ptr_eq(block->ibuf->iis[0]->next, NULL);
	ck_assert_int_eq(((cns_buf_ii *)block->ibuf->iis[6]->data)->idx, 6);
	ck_assert_int_eq(((cns_buf_ii *)block->ibuf->iis[6]->data)->itft, CNS_INPUT);
	ck_assert_ptr_eq(block->ibuf->iis[1]->next, NULL);
	ck_assert_int_eq(((cns_buf_ii *)block->wbuf->iis[5]->data)->idx, 5);
	ck_assert_int_eq(((cns_buf_ii *)block->wbuf->iis[5]->data)->itft, CNS_WEIGHT);
	ck_assert_ptr_eq(block->wbuf->iis[0]->next, NULL);
	ck_assert_int_eq(((cns_buf_ii *)block->wbuf->iis[6]->data)->idx, 6);
	ck_assert_int_eq(((cns_buf_ii *)block->wbuf->iis[6]->data)->itft, CNS_WEIGHT);
	ck_assert_ptr_eq(block->wbuf->iis[1]->next, NULL);
	ck_assert_int_eq(((cns_buf_ii *)block->obuf->iis[5]->data)->idx, 9);
	ck_assert_int_eq(((cns_buf_ii *)block->obuf->iis[5]->data)->itft, CNS_OUTPUT);
	ck_assert_ptr_eq(block->obuf->iis[0]->next, NULL);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[5]->data)->idx, 7);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[5]->data)->itft, CNS_INPUT);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[5]->next->data)->idx, 5);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[5]->next->data)->itft, CNS_OUTPUT);
	ck_assert_ptr_eq(block->cbuf->iis[0]->next->next, NULL);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[6]->data)->idx, 7);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[6]->data)->itft, CNS_WEIGHT);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[6]->next->data)->idx, 6);
	...
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[7]->data)->itft, CNS_INPUT);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[7]->next->data)->idx, 7);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[7]->next->data)->itft, CNS_OUTPUT);
	ck_assert_ptr_eq(block->cbuf->iis[2]->next->next, NULL);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[8]->data)->idx, 8);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[8]->data)->itft, CNS_WEIGHT);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[8]->next->data)->idx, 8);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[8]->next->data)->itft, CNS_OUTPUT);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[8]->next->next->data)->idx, 9);
	ck_assert_int_eq(((cns_buf_ii *)block->cbuf->iis[8]->next->next->data)->itft, CNS_INPUT);
	ck_assert_ptr_eq(block->cbuf->iis[8]->next->next->next, NULL);
	...
	ck_assert_ptr_eq(block->cells[5].data.input, block->ibuf->buf+5);
	ck_assert_ptr_eq(block->cells[5].data.weight, block->wbuf->buf+5);
	ck_assert_ptr_eq(block->cells[5].data.output, block->cbuf->buf+5);
	ck_assert_ptr_eq(block->cells[6].data.input, block->ibuf->buf+6);
	ck_assert_ptr_eq(block->cells[6].data.weight, block->wbuf->buf+6);
	ck_assert_ptr_eq(block->cells[6].data.output, block->cbuf->buf+6);
	ck_assert_ptr_eq(block->cells[7].data.input, block->cbuf->buf+5);
	ck_assert_ptr_eq(block->cells[7].data.weight, block->cbuf->buf+6);
	ck_assert_ptr_eq(block->cells[7].data.output, block->cbuf->buf+7);
	ck_assert_ptr_eq(block->cells[8].data.input, block->cbuf->buf+7);
	ck_assert_ptr_eq(block->cells[8].data.weight, block->cbuf->buf+8);
	ck_assert_ptr_eq(block->cells[8].data.output, block->cbuf->buf+8);
	ck_assert_ptr_eq(block->cells[9].data.input, block->cbuf->buf+8);
	ck_assert_ptr_eq(block->cells[9].data.weight, NULL);
	ck_assert_ptr_eq(block->cells[9].data.output, block->obuf->buf+5);
